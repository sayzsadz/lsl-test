create or replace PACKAGE BODY XXPBSAPO_INVOICES_SV1 AS
/* $Header: POXIVCRB.pls 120.11.12020000.2 2013/12/18 15:44:31 honwei ship $ */
...
g_log_head    CONSTANT VARCHAR2(50) := 'po.plsql.XXPBSAPO_INVOICES_SV1.';
/* <CANCEL ASBN FPI END> */

/* <PAY ON USE FPI START> */
g_pkg_name CONSTANT VARCHAR2(50) := 'XXPBSAPO_INVOICES_SV1';
/* <PAY ON USE FPI END> */
...
PROCEDURE  create_ap_invoices(X_transaction_source	 IN	 VARCHAR2,
			      ...
			      X_include_timecard_correct IN      VARCHAR2)--Bug 17972946
...
/* <PAY ON USE FPI> */
 ...
 BEGIN
	...
	X_receipt_completion_status :=
		XXPBSAPO_INVOICES_SV2.create_receipt_invoices(X_commit_interval,
 		                                X_shipment_header_id,
					        X_receipt_event, X_aging_period,
 		                                X_include_timecard_correct);--Bug 17972946
...
/* <PAY ON USE FPI START> */
        XXPBSAPO_INVOICES_SV2.create_use_invoices(
            1.0,
...
/* <PAY ON USE FPI START> */
	...
	X_receipt_completion_status :=
		XXPBSAPO_INVOICES_SV2.create_receipt_invoices(
                  X_commit_interval,
                  X_shipment_header_id,
                  X_receipt_event,
                  X_aging_period,
