...
IS
  ...
  IS
    ...
    L_OUTLET_NAME   varchar2(100);
  
    CURSOR c_requistion_rec(p_in VARCHAR2)
    IS
...
--      );
    ...
    FOR v_requistion_rec IN c_requistion_rec(NULL)
    LOOP
      ...
      IF lv_error_flag IS NULL THEN
        ...
        INTO PO_REQUISITIONS_INTERFACE_ALL
          ...
          (
            ...
            ld_need_by_date ,
            ln_org_id ,
            (v_requistion_rec.unit_price - (v_requistion_rec.tax1 + v_requistion_rec.tax2)),
            'Y' ,
            ln_vendor_id ,
            ln_site_id
           ...
           --,PO_REQ_DIST_INTERFACE_S.nextval
           ,NULL
           ,v_requistion_rec.ATTRIBUTE9
           ,v_requistion_rec.ATTRIBUTE8
           ,v_requistion_rec.ATTRIBUTE7
           ,v_requistion_rec.ATTRIBUTE6
           ,v_requistion_rec.ATTRIBUTE5
           ,v_requistion_rec.ATTRIBUTE4
           ,l_outlet_name
          );
