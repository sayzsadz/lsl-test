--Create an item so that thing to do we use the intermediate table value as the adjusted
CREATE OR REPLACE PROCEDURE XXPBSA_JE_INTERFACE_PROD_MOVE(errbuf OUT NOCOPY VARCHAR2, retcode OUT NOCOPY VARCHAR2) 
IS        
        cursor cur
        is
